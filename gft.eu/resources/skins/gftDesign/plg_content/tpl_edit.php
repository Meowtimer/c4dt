...
$HTML = <<<ADCE
	...
	<textarea name="{arco.name.main_tpl}" rows="40" cols="80">$tpl</textarea><br>
...
public function tpl_row($name,$content,$id) {
$HTML = <<<ADCE
<input type="text" name="{arco.name.field_name}[$id]" value="$name"/><textarea name="{arco.name.field_content}[$id]" rows="10" cols="50">$content</textarea><br>
ADCE;
return $HTML;
}
}
