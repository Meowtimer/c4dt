...
public class Function extends NamedReference implements IComplainingIniEntry {
	...
	public void complain(ComplexIniEntry context) {
		...
		if (f != null) {
			...
			if (obj != null && obj.findLocalFunction(this.toString(), true) == null)
				iniUnit.markerAtValue(ParserErrorCode.UndeclaredIdentifier, context, IMarker.SEVERITY_ERROR, toString());
		}
	}
