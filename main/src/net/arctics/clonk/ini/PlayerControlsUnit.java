...
public class PlayerControlsUnit extends IniUnitWithNamedSections implements IGlobalVariablesContributor {
	public static final String CONFIG_NAME = "PlayerControls.txt";
	...
	@Override
	public Collection<Variable> globalVariables() { return controlVariables(); }
}
