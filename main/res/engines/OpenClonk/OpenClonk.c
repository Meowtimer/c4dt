...
static const int C4D_Border_Top;
static const int C4D_Border_Sides;
static const int C4D_Border_Bottom;
...
static const int C4FO_AnyLayer;
...
static const int CNAT_PhaseHalfVehicle;
...
global func int GetDefWidth();
global func int GetDefHeight();
...
global func int GetMaterialTextureIndex(string material_texture);
global func int GetDefaultBackgroundIndex(any value);
